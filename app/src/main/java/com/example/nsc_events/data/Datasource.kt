    ...
    fun loadEvents(): List<Event> {
        ...
        return listOf(
            Event("Thanksgiving Pageant", "A play put on by the acting department.", "fun",
                ...
                "school", "www.NSCEvents.com/thanksgiving",  "now", "100",
                listOf("thanks", "giving"), "all day", arrayOf("none"), "none", "no cancellations",
                "teacher", SocialMedia("my facebook","my twitter", "my instagram", "my hashtag"),
                "no privacy", "not very good", "happy thanksgiving", true, "65659e84e0686d0542e26a84"),
            Event("New Year's Day Celebration", "Meet with fellow students to celebrate the first day of the new year!", "fun",
                ...
                "school", "www.NSCEvents.com/newyears", "now", "100",
                listOf("thanks", "giving"), "all day", arrayOf("none"), "none", "no cancellations",
                "teacher", SocialMedia("my facebook","my twitter", "my instagram", "my hashtag"),
                "no privacy", "not very good", "let's celebrate the new year", true, "655f139d518629964f8e3d67"),
            Event("Increase the Peace Gathering", "Come together with other students to listen to a speech on world peace", "fun",
                ...
                "school", "www.NSCEvents.com/peacegathering", "now", "100",
                listOf("thanks", "giving"), "all day", arrayOf("none"), "none", "no cancellations",
                "teacher", SocialMedia("my facebook","my twitter", "my instagram", "my hashtag"),
                "no privacy", "not very good", "all are welcome", true, "1"),
        )
    }
