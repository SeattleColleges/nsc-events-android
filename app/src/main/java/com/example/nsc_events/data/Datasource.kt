    ...
    fun loadEvents(): List<Event> {
        ...
        return listOf(
            Event("Thanksgiving Pageant", "A play put on by the acting department.", "fun",
                Date(20231103), "7PM", "9PM","Stage One Theater", R.drawable.ic_launcher_background.toString(),
